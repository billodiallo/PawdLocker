...
class TestUsers(unittest.TestCase):
	...
	def setUp(self):
		...
		"""
		self.new_user = Users("billo","diallo","pswd001")
		
	def test_init(self):
		"""
		#test_init test case to test if the object is the initialized properly
		"""
		self.assertEqual(self.new_user.first,"billo")
		self.assertEqual(self.new_user.last,"diallo")
...
class TestCredentials(unittest.TestCase):
	...
	def test_auth_check(self):
		...
		"""
		self.new_user = Users("billo","diallo","pswd002")
		self.new_user.create_user()
	...
	def test_init(self):
		...
		"""
		self.new_cred = Credentials("billo","diallo","BD","pswd001")
		self.assertEqual(self.new_cred.name, "billo")
		self.assertEqual(self.new_cred.username, "diallo")
		self.assertEqual(self.new_cred.platform, "BD")
	...
	def test_show_credentials(self):
		...
		self.new_cred = Credentials("billo","diallo","BD","pswd001")
		self.new_cred.save_cred()
		self.another_cred = Credentials("billo","diallo","BD","pswd001")
